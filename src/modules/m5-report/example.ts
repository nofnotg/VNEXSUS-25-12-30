/**
 * M5 Report Module Example
 * 
 * 보고서 생성 모듈 사용 예제
 */

import m5ReportModule from './index';
import eventGrouper from '../../lib/eventGrouper';
import periodFilter from '../../lib/periodFilter';
import { PeriodPreset } from '../../lib/periodFilter';
import type { ParsedEvent } from '../../lib/ocrParser';
