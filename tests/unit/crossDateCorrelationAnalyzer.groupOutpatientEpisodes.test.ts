...
describe('groupOutpatientEpisodes', () => {
  const analyzer = new CrossDateCorrelationAnalyzer();

  it('merges similar respiratory visits within window', () => {
    const records = [
  ...
  it('does not merge different diagnostic groups', () => {
    const records = [
  ...
  it('applies same hospital boost to help merge borderline cases', () => {
    const records = [
  ...
  it('boosts treatment continuity for follow-up prescriptions', () => {
    const records = [
  ...
  it('respects windowDays boundary and does not merge far apart visits', () => {
    const records = [
