    ...
    const tests = [
        {
            ...
            method: 'POST',
            body: { rawText: testData.text, options: { includeProcessedData: true } }
        },
        {
        ...
        },
        {
            ...
            method: 'POST',
            body: { documentText: testData.text }
        },
        {
            name: '후처리 파이프라인',
            url: 'http://localhost:3030/api/postprocess',
            method: 'POST',
            body: { ocrResults: [{ text: testData.text, confidence: 0.95 }], options: { includeProcessedData: true } }
        }
    ];
