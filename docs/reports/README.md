...
의료 보험 손해사정 보고서 OCR 분석 및 검증 보고서 저장소
...
```
YYYY-MM-DD-{report-type}-{description}.html
```

**예시:**
- `2025-01-18-validation-report-28-cases.html`
- `2025-01-18-validation-comprehensive.html`
- `2025-01-18-quick-win-final-report.html`
...
1. HTML 파일을 날짜 기반 네이밍으로 저장
2. `index.html`에 새 보고서 카드 추가
3. 이 README.md 업데이트
4. 커밋 메시지: `추가: YYYY-MM-DD {보고서 제목}`

## 📝 커밋 히스토리

- **2025-01-18:** 초기 보고서 4건 업로드 (검증/종합/Quick Win/OCR 전략)
